...
public sealed interface JobCompletionResult<Result : Any> {
     ...
     */
    public data class Success<Result : Any>(
     ...
     */
    public data class Cancelled<Result : Any>(
     ...
     */
    public data class Timeout<Result : Any>(
     ...
     */
    public data class Failure<Result : Any>(
        val cause: Exception,
        val retryDelay: Duration,
        val permanentlyFail: Boolean,
        val skipAttempt: Boolean,
    ) : JobCompletionResult<Result>
}
