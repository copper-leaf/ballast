...
> DEPRECATED
> 
> This module was based on a flawed concept of application architecture, and has not proved to be as useful as initially
> envisioned when originally created. For historical reasons, this module and its original documentation has been 
> preserved for those who may have already been using it, but it will not receive any further updates or support. 
> 
> In short, Ballast is best used strictly in the Presentation Layer of your application. It is not well-suited for 
> managing caches in the Data Layer, or for encapsulating business logic in the Domain Layer. 
